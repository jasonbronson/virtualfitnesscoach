...
<style type="text/css">
	@import url(/homepage/css/mainlayout_reg.css);
</style>
        ...
        <div id="main-content-header">
    		<div id="main-content-header-left">
    			<a name="Virtual Fitness Coach Home" href="index.php">
                	<img alt="Virtual Fitness Coach Logo" src="/homepage/images/Tentative_Logo.jpg" />
                </a>
        	</div>
                	...
                	<tr>
                        ...
                        <td>
                        	<a name="Virtual Fitness Coach Join Now" href="join_now.php">
                            	<img alt="Virtual Fitness Coach Join Now" src="/homepage/images/join-now.jpg" />
                            </a>
                        </td>                
                	</tr>
                </table>-->
