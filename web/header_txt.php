...
if ($geturlvar == "employee-health-and-wellness.php"){
            ...
            <div id="main-content-header-right">
            	<div id="main-content-header-right-top-number">
                    ...
                    //echo substr(substr($_SERVER["SCRIPT_NAME"],strrpos($_SERVER["SCRIPT_NAME"],"/")+1),4);
                     ...
                     </span>---><span style="color:#000000;margin-left:4px;font-weight:bold; font-family:Arial, Helvetica, sans-serif;">1-843-270-2548</span> <span style="margin-left:2px;margin-right:2px;color:#666666;"> | </span><a 
