            ...
            <div id="main-content-header-right">
            	<div id="main-content-header-right-top-number">
                    ...
                    //echo substr(substr($_SERVER["SCRIPT_NAME"],strrpos($_SERVER["SCRIPT_NAME"],"/")+1),4);
                     ...
                     </span>---><span style="color:#000000;margin-left:4px;font-weight:bold; font-family:Arial, Helvetica, sans-serif;">
                     	<a href="/wellness-calculator.php">Wellness ROI Calculator</a> &nbsp; &nbsp; &nbsp; 
                     	1-888-480-7835</span> <span style="margin-left:2px;margin-right:2px;color:#666666;"> | </span><a 
...
<div style=" float:left;">
        	...
        	</div>            <div id="main-content-navbar-right">        
        	</div>
        </div>
