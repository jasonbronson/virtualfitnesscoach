...
if ($geturlvar == "index.php" or $geturlvar == "index_a.php" or $geturlvar == "veteran_fitness.php"  ){
    ...
    <div id="main-content">
        ...
        <div id="main-content-header-left">
        	<a name="Virtual Fitness Coach Home" href="index.php">
                  <img alt="Virtual Fitness Coach" src="/homepage/images/virtual_fitness_coach_millenia.jpg" />
                </a>
                </div>
