            ...
            <div id="main-content-feature-left" style="width:948px;background:none;">
                ...
                <div id="main-content-feature-left-middle" style="margin-top:14px;margin-left:auto; margin-right:auto; text-align:center;">
                  <div style="border:20px #25408f solid; margin-left:auto; margin-right:auto;">
                    <!-- end the blue div -->
                    <div>
                      <img src="/homepage/images/px-img5.jpg" alt="virtual fitness coach" style="margin-left:auto;margin-right:auto;margin-top:40px:margin-bottom:40px" />
                      <div style="text-align:left;margin-left:20px;font-size:14px;">
                        <h1 align="center">Health & Wellness Savings Calculator.</h1>
                      
<br>                        


                        <h2>Facts:</h2>
<ol style="text-align:left;margin-left:40px;font-size:12px;">                       
<li><b>32.2 % of Adult Americans are Obese</b>
	<br>The National Center for Health Statistics Report<br><br>
<li><b>34.1% of Adult Americans are Overweight</b>
	<br>The Centers for Disease Control and Prevention (CDC) Report<br><br>
<li><b>$9,500/Year Health Care Cost per Employee</b>
	<br>Nationwide Average Employer Covered Health Care Spending<br><br>
<li><b>Excessive Absentism Negatively Affects Company Profits</b>
	<br>The International Journal of Obesity reports Obese Employees miss<br>13 times more scheduled work days than their healthy-weight colleagues.
</ol>
<br>                        
<h2>Savings:</h2>
                      <div style="text-align:left;margin-left:40px;font-size:14px;">Virtual Fitness Coach will improve your employees health while adding income to your bottom line.<br>  Your 				company wins!  Your employees win!	</div>

<br><br>
<h4>*Simply enter the number of company employees and click on "Calculate Wellness Savings."</h4>    
...
<table border=0 width="75%"><tr><td><font face="arial, helvetica" size="-1">
	...
	<li>A study from Kaiser Permanente indicates that a modest weight loss of 5%, attained by participation in a health program, resulted in cost savings from the 
...
<span style="color:#25408f">For more information, <a href="mailto:support@virtualfitnesscoach.com">contact our team</a> and review the information on the <A href="/ROI-on-health-and-wellness.php">ROI page</a>.</span>
