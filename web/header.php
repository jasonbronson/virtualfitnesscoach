...
if ($geturlvar == "welcome.php" or $geturlvar == "index8.php" or $geturlvar == "index_a.php" or $geturlvar == "veteran_fitness.php"  ){
...
<div id="wrapper">
    ...
    <div id="main-content">
        ...
        <div id="main-content-header-left">
          <a name="Virtual Fitness Coach Home" href="welcome.php">
          ...
          <div id="main-content-navbar-left">
            ...
            <div id="main-content-navbar-middle">
                  <div style=" float:left;">
                          <a name="Virtual Fitness Coach Welcome" href="welcome.php">
